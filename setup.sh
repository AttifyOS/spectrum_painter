...
install() {
  ...
  $APM_PKG_INSTALL_DIR/python/bin/pip3.9 install git+https://github.com/polygon/spectrum_painter@b8aef4b69551220e6ea520d345953e3a3873eef7
  ln -s $APM_PKG_INSTALL_DIR/python/bin/spectrum_painter $APM_PKG_BIN_DIR/
...
uninstall() {
  ...
  rm $APM_PKG_BIN_DIR/spectrum_painter
}
